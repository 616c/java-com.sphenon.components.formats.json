...
import com.sphenon.formats.json.services.*;

public class JSONPackageInitialiser {
    ...
    static public void initialise (CallContext context) {
        ...
        if (initialised == false) {
            ...
            ServiceRegistry.registerService(context, new RESTResponseEncoder_JSON(context));
        }
    }
}
